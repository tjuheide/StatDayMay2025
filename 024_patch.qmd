...
Are the labels a bit close to the numbers in the at risk table? Check out the [cheap trick](993_label_spacing.qmd) which was applied when making [this version of the figure](020_front.qmd).