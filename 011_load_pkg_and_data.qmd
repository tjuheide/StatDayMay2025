...
Below labels are set for the exposure variable, you may use different labels if you have other preferences.
...
Set preferences for base size in plots (this will affect sizes of axis titles and labels, legends, etc. but not the size of elements within the plot) and specify your 2 favorite colors for plotting curves.

The base size determines how large text in the plot will be.

```{r}
bsize <- 15
```

[There are many different named colors](https://debruine.github.io/30DCC-2022/app-a-colours.html):
